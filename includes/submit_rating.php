...
$sql=mysqli_query($conn,"SELECT * FROM avatrade WHERE lang='$lang' AND user_email='$emailfor'");
  if($f=mysqli_fetch_assoc($sql)){
	  	  
	  echo "You have reviewed this  before";
  }else{
...
if(isset($_POST["action"]))
{
	...
	$query = "
	SELECT * FROM avatrade WHERE lang='$lang'
